...
const DefaultButton: React.FC<DefaultButtonType> = ({ href, name, onPress }) => {
    return (
        <TouchableOpacity style={styles.actionButton} onPress={onPress}>
            {href ? (
                <Link href={href} style={{ width: '100%', height: '100%', textAlign: 'center', textAlignVertical: 'center' }}>
                    <LinearGradient
                        ...
                        <CustomText style={styles.actionButtonText} weight="Bold">{name}</CustomText>
                    </LinearGradient>
                </Link>
            ) : (
                <LinearGradient
